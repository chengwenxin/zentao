    ...
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
        <tbody>
          ...
          <tr>
            <th class='w-110px'><?php echo $lang->bug->automatedTesting;?></th>
            <td class='w-p45-f'>
              <div class='input-group'>
                <?php
                echo html::select('automatedTesting', $lang->bug->automatedTestingList, 0, "class='form-control chosen'");
                ?>
              </div>
            </td>
            ...
            <td>
              <div class='input-group' >
              <span class="input-group-addon"><?php echo $lang->bug->defectSource?></span>
                <?php
                echo html::select('defectSource', $lang->bug->defectSourceList, 0, " class='form-control chosen'");
                ?>
              </div>
            </td>
          </tr>
