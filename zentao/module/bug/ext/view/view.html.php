          ...
          <div class='tab-pane active' id='legendBasicInfo'>
            <table class="table table-data">
              <tbody>
                ...
                <tr>
                  <th><?php echo $lang->bug->defectSource;?></th>
                  <td><?php if(isset($lang->bug->typeList[$bug->defectSource])) echo $lang->bug->typeList[$bug->defectSource]; else echo $bug->defectSource;?></td>
                </tr>
                <tr>
                  <th><?php echo $lang->bug->automatedTesting;?></th>
                  <td><?php if(isset($lang->bug->typeList[$bug->automatedTesting])) echo $lang->bug->typeList[$bug->automatedTesting]; else echo $bug->automatedTesting;?></td>
                </tr>
                <tr>
                  <?php
