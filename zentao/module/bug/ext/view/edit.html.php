            ...
            <table class='table table-form'>
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo html::select('defectSource', $lang->bug->defectSourceList, $bug->defectSource, "class='form-control chosen'");?></td>
                </tr>
                <tr>
                  <th><?php echo $lang->bug->automatedTesting;?></th>
                  <td><?php echo html::select('automatedTesting', $lang->bug->automatedTestingList, $bug->automatedTesting, "class='form-control chosen'");?></td>
                </tr>
                <tr>
